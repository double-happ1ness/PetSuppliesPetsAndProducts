...
public class Pet implements SortedADT {
    ...
    public String toString() {
        ...
        if (this.root != null) {
            treeDetails += this.getTree(this.root);
        } else {
    ...
    private String getTree(BinarySearchTreeNode current) {
        String treeDetails = new String();
        if (current != null) {
            treeDetails += this.getTree(current.left);
            treeDetails += current.object + "\n";
            treeDetails += this.getTree(current.right);
        }
        return treeDetails;
    }
